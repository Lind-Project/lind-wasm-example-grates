...
pub extern "C" fn fork_handler(
    ...
    if helpers::is_cage_clamped(arg1cage) {
        ...
        helpers::clone_cage_state(arg1cage, child_cage_id);
...
pub extern "C" fn ns_access_handler(
    ...
    let nr = match helpers::get_route(arg1cage, SYS_ACCESS) {
        Some(alt) => match helpers::read_path_from_cage(arg1, arg1cage) {
            Some(path) if helpers::path_matches_prefix(&path) => alt,
            _ => SYS_ACCESS,
        },
...
pub extern "C" fn ns_unlink_handler(
    ...
    let nr = match helpers::get_route(arg1cage, SYS_UNLINK) {
        Some(alt) => match helpers::read_path_from_cage(arg1, arg1cage) {
            Some(path) if helpers::path_matches_prefix(&path) => alt,
            _ => SYS_UNLINK,
        },
...
pub extern "C" fn ns_mkdir_handler(
    ...
    let nr = match helpers::get_route(arg1cage, SYS_MKDIR) {
        Some(alt) => match helpers::read_path_from_cage(arg1, arg1cage) {
            Some(path) if helpers::path_matches_prefix(&path) => alt,
            _ => SYS_MKDIR,
        },
...
pub extern "C" fn ns_rmdir_handler(
    ...
    let nr = match helpers::get_route(arg1cage, SYS_RMDIR) {
        Some(alt) => match helpers::read_path_from_cage(arg1, arg1cage) {
            Some(path) if helpers::path_matches_prefix(&path) => alt,
            _ => SYS_RMDIR,
        },
...
pub extern "C" fn ns_rename_handler(
    ...
    let nr = match helpers::get_route(arg1cage, SYS_RENAME) {
        Some(alt) => match helpers::read_path_from_cage(arg1, arg1cage) {
            Some(path) if helpers::path_matches_prefix(&path) => alt,
            _ => SYS_RENAME,
        },
...
pub extern "C" fn ns_truncate_handler(
    ...
    let nr = match helpers::get_route(arg1cage, SYS_TRUNCATE) {
        Some(alt) => match helpers::read_path_from_cage(arg1, arg1cage) {
            Some(path) if helpers::path_matches_prefix(&path) => alt,
            _ => SYS_TRUNCATE,
        },
...
pub extern "C" fn ns_chmod_handler(
    ...
    let nr = match helpers::get_route(arg1cage, SYS_CHMOD) {
        Some(alt) => match helpers::read_path_from_cage(arg1, arg1cage) {
            Some(path) if helpers::path_matches_prefix(&path) => alt,
            _ => SYS_CHMOD,
        },
...
pub extern "C" fn ns_readlink_handler(
    ...
    let nr = match helpers::get_route(arg1cage, SYS_READLINK) {
        Some(alt) => match helpers::read_path_from_cage(arg1, arg1cage) {
            Some(path) if helpers::path_matches_prefix(&path) => alt,
            _ => SYS_READLINK,
        },
...
pub extern "C" fn ns_readlinkat_handler(
    ...
    let nr = match helpers::get_route(arg1cage, SYS_READLINKAT) {
        Some(alt) => match helpers::read_path_from_cage(arg1, arg1cage) {
            Some(path) if helpers::path_matches_prefix(&path) => alt,
            _ => SYS_READLINKAT,
        },
...
pub extern "C" fn ns_read_handler(
    ...
    let nr = match helpers::get_route(arg1cage, SYS_READ) {
        Some(alt)
...
pub extern "C" fn ns_write_handler(
    ...
    let nr = match helpers::get_route(arg1cage, SYS_WRITE) {
        Some(alt)
            if fdtables::translate_virtual_fd(arg1cage, arg1)
                .map(|e| e.perfdinfo != 0)
                .unwrap_or(false) =>
...
pub extern "C" fn ns_pread_handler(
    ...
    let args = [arg1, arg2, arg3, arg4, arg5, arg6];
    let arg_cages = [arg1cage, arg2cage, arg3cage, arg4cage, arg5cage, arg6cage];
    let nr = match helpers::get_route(arg1cage, SYS_PREAD) {
        Some(alt)
            if fdtables::translate_virtual_fd(arg1cage, arg1)
                .map(|e| e.perfdinfo != 0)
                .unwrap_or(false) =>
...
pub extern "C" fn ns_pwrite_handler(
    ...
    let args = [arg1, arg2, arg3, arg4, arg5, arg6];
    let arg_cages = [arg1cage, arg2cage, arg3cage, arg4cage, arg5cage, arg6cage];
    let nr = match helpers::get_route(arg1cage, SYS_PWRITE) {
        Some(alt)
            if fdtables::translate_virtual_fd(arg1cage, arg1)
                .map(|e| e.perfdinfo != 0)
                .unwrap_or(false) =>
...
pub extern "C" fn ns_lseek_handler(
    ...
    let args = [arg1, arg2, arg3, arg4, arg5, arg6];
    let arg_cages = [arg1cage, arg2cage, arg3cage, arg4cage, arg5cage, arg6cage];
    let nr = match helpers::get_route(arg1cage, SYS_LSEEK) {
        Some(alt)
            if fdtables::translate_virtual_fd(arg1cage, arg1)
                .map(|e| e.perfdinfo != 0)
                .unwrap_or(false) =>
...
pub extern "C" fn ns_fstat_handler(
    ...
    let args = [arg1, arg2, arg3, arg4, arg5, arg6];
    let arg_cages = [arg1cage, arg2cage, arg3cage, arg4cage, arg5cage, arg6cage];
    let nr = match helpers::get_route(arg1cage, SYS_FXSTAT) {
        Some(alt)
            if fdtables::translate_virtual_fd(arg1cage, arg1)
                .map(|e| e.perfdinfo != 0)
                .unwrap_or(false) =>
...
pub extern "C" fn ns_ftruncate_handler(
    ...
    let args = [arg1, arg2, arg3, arg4, arg5, arg6];
    let arg_cages = [arg1cage, arg2cage, arg3cage, arg4cage, arg5cage, arg6cage];
    let nr = match helpers::get_route(arg1cage, SYS_FTRUNCATE) {
        Some(alt)
            if fdtables::translate_virtual_fd(arg1cage, arg1)
                .map(|e| e.perfdinfo != 0)
                .unwrap_or(false) =>
...
pub extern "C" fn ns_fchmod_handler(
    ...
    let args = [arg1, arg2, arg3, arg4, arg5, arg6];
    let arg_cages = [arg1cage, arg2cage, arg3cage, arg4cage, arg5cage, arg6cage];
    let nr = match helpers::get_route(arg1cage, SYS_FCHMOD) {
        Some(alt)
            if fdtables::translate_virtual_fd(arg1cage, arg1)
                .map(|e| e.perfdinfo != 0)
                .unwrap_or(false) =>
...
pub extern "C" fn ns_readv_handler(
    ...
    let args = [arg1, arg2, arg3, arg4, arg5, arg6];
    let arg_cages = [arg1cage, arg2cage, arg3cage, arg4cage, arg5cage, arg6cage];
    let nr = match helpers::get_route(arg1cage, SYS_READV) {
        Some(alt)
            if fdtables::translate_virtual_fd(arg1cage, arg1)
                .map(|e| e.perfdinfo != 0)
                .unwrap_or(false) =>
...
pub extern "C" fn ns_writev_handler(
    ...
    let args = [arg1, arg2, arg3, arg4, arg5, arg6];
    let arg_cages = [arg1cage, arg2cage, arg3cage, arg4cage, arg5cage, arg6cage];
    let nr = match helpers::get_route(arg1cage, SYS_WRITEV) {
        Some(alt)
            if fdtables::translate_virtual_fd(arg1cage, arg1)
                .map(|e| e.perfdinfo != 0)
                .unwrap_or(false) =>
