...
int main(void) {
    ...
    if (pid == 0) {
        ...
        /* Child: read back /tmp/foo — should see child's data, not parent's */
    ...
    if (pid == 0) {
        ...
        printf("  PASS: child: /tmp/a.txt not visible (independent imfs)\n");
        ...
        printf("  PASS: child: /tmp/b.txt not visible (independent imfs)\n");
        _exit(0);
    }
