...
int getuid_grate(uint64_t cageid, uint64_t arg1, uint64_t arg1cage,
  ...
  return make_threei_call(GETUID_SYSCALL, 0, cageid, arg1cage, arg1,
...
int main(int argc, char *argv[]) {
  ...
  if (pid < 0) {
    ...
    uint64_t fn_ptr_addr = (uint64_t)(uintptr_t)&getuid_grate;
    int ret = register_handler(cageid, GETUID_SYSCALL, grateid, fn_ptr_addr);
